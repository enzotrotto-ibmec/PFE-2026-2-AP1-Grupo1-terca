...
## Estrutura do repositório (ainda será organizado direitinho)
...
**03 - 5W2H**
Plano de ação estruturado (What, Why, Where, When, Who, How, How much) para orientar a execução do projeto de planejamento.

**04 - Documento de Visão**
Documento que descreve o problema, os objetivos do projeto, o público-alvo, as premissas, restrições e a visão geral da solução proposta.

**05 - AHT (Árvore Hierárquica de Tarefas)**
Decomposição das tarefas do usuário no site em uma estrutura hierárquica, usada como base para pensar a navegação e a arquitetura de informação do protótipo.
