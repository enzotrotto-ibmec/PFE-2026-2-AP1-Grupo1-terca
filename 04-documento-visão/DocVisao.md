...
Este documento tem como objetivo descrever o problema enfrentado pela **PKZ Lab & One to One**, as necessidades levantadas junto ao cliente, o público a ser atendido pela solução e a visão geral da proposta a ser desenvolvida pela equipe ao longo do projeto de avaliação da disciplina Projeto Frontend.

Ele serve como base de alinhamento entre a equipe 1 e o cliente sobre **o que será construído e por quê**. Nesta etapa do projeto, o trabalho é de **planejamento**, não há alteração no site real ou criação de uma página web do cliente propriamente dita.
...
| | |
|---|---|
| **O problema:** | falta de um canal digital próprio e profissional da PKZ |
| **Afeta:** | a PKZ/PlayMakerz e seus potenciais clientes (atletas de alto rendimento e praticantes de todos os esportes) |
| **Tem como impacto:** | baixo alcance digital, dificuldade de qualificar novos clientes, comunicação incompleta do valor do CT e dependência de intermediários no funil de aquisição |
...
- **Identidade visual coesa:** apresentação mais profissional das duas marcas, hoje descrita como carente de acabamento.
